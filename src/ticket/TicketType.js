...
const DATA = [
  {
    title: 'Show Only',
    content: 'ตื่นตาตื่นใจกับการแสดงรูปแบบใหม่ KAAN Presented by SINGHA CORPORATION โชว์ไทย<br>โปรดักชั่นระดับโลกที่จะทำให้คุณได้สัมผัสประสบการณ์สุดประทับใจแบบไม่มีวันลืมตลอด 90 นาที',
  ...
  {
    title: 'Promotion',
    content: `รับข้อเสนอสุดพิเศษ และ<br>โปรโมชั่นอื่นๆ อีกมากมาย พร้อมตื่นตาตื่นใจกับการแสดงรูปแบบใหม่ KAAN Presented by SINGHA CORPORATION
  ...
  },
  {
    ...
    พร้อมตื่นตาตื่นใจกับการแสดงรูปแบบใหม่ KAAN Presented by SINGHA CORPORATION โชว์ไทย<br>โปรดักชั่นระดับโลกที่จะทำให้คุณได้สัมผัสประสบการณ์สุดประทับใจแบบไม่มีวันลืมตลอด 90 นาที`,
    link: '/ticket/form/'
  }
]
