    ...
    return (
      <div className={styles.container}>
        ...
        <p>
          ...
          คานได้เดินทางไปสู่ดินแดนสุดมหัศจรรย์ เขาได้พบกับตัวละครในวรรณคดีไทยต่างๆ มากมาย ไม่ว่าจะเป็น พระอภัยมณี ผีเสื้อสมุทร พรานบุญ
          กินรี เงาะป่า เมขลา รามสูร ไกรทอง ชาละวัน พระราม พระลักษณ์  และทศกัณฐ์
          การผจญภัยครั้งนี้จะสอนให้เขาได้เรียนรู้ และเติบโตเป็นชายหนุ่มที่สมบูรณ์อย่างที่พ่อตั้งใจได้ หรือไม่ ติดตามได้ใน KAAN ...
        </p>
      </div>
    )
  }
